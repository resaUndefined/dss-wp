    ...
    <div class="right_col" role="main">
      ...
      <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Edit Sub Kriteria <small>Manajemen Sub Kriteria</small></h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                ...
                @endif
                <form id="form1" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('subkriteria.update') }}">
                    {{ csrf_field() }}
                    <input name="_method" type="hidden" value="PUT">
                    <input type="hidden" name="id" value="{{ $subKriteriaEdit->id }}">
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Keterangan <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="keterangan" name="keterangan" required="required" class="form-control col-md-7 col-xs-12" value="{{ $subKriteriaEdit->keterangan }}">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="bobot" name="bobot" required="required" class="form-control col-md-7 col-xs-12" value="{{ $subKriteriaEdit->bobot }}">
                      </div>
                    </div>
                    <div class="ln_solid"></div>
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a href="{{ route('kriteria.edit', $subKriteriaEdit->kriteria_id) }}" type="button" class="btn btn-primary"><i class="fa fa-rotate-left"></i> Kembali</a>
